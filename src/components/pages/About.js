    ...
    <div id="about" className="container mb-5">
      <div className="card">
        ...
        <div id="bio" className="card-body">
          ...
          <p>
            When I'm not busy writing code, fixing strange bugs, and hoping that
            my computer isn't on fire while trying to get things working again,
            I like playing music, video games, and watching sports.
          </p>
          <p>
